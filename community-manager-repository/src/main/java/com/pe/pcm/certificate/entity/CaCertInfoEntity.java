 ...
 */
@Entity
@Table(name = "CA_CERT_INFO")
public class CaCertInfoEntity extends SciAudit implements Serializable {
    ...
    @NotNull
    private String caCertificateInfoKey;

    public CaCertInfoEntity() {
        // Allowing to create Object with Default Constructor
    }
    ...
    public String getCaCertificateInfoKey() {
        return caCertificateInfoKey;
    }

    public void setCaCertificateInfoKey(String caCertificateInfoKey) {
        this.caCertificateInfoKey = caCertificateInfoKey;
    }
    ...
    public String toString() {
        return "CACertInfo [objectId=" + objectId + ", name=" + name + ", username=" + username + ", createDate="
                ...
                + ", verifyOnUse=" + verifyOnUse + ", ocspInfo=" + ocspInfo + ", caCertificateInfoKey="
                + caCertificateInfoKey + "]";
    }
