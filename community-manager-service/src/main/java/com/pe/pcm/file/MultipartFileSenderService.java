...
public class MultipartFileSenderService {
    private static final Logger LOGGER = LoggerFactory.getLogger(MultipartFileSenderService.class);

    private static final int DEFAULT_BUFFER_SIZE = 20480; // ..bytes = 20KB.
    private static final long DEFAULT_EXPIRE_TIME = 1800000L; // ..ms = 30Minutes.
    private static final String MULTIPART_BOUNDARY = "MULTIPART_BYTERANGES";

    public void serveResource(Path filepath, HttpServletRequest request,
