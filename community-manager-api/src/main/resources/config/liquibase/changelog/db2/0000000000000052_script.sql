...
(
    ...
    CORRELATION_VALUE_18 VARCHAR(500),
    CORRELATION_VALUE_19 VARCHAR(500),
    CORRELATION_VALUE_20 VARCHAR(500),
    CORRELATION_VALUE_21 VARCHAR(500),
    CORRELATION_VALUE_22 VARCHAR(500),
    CORRELATION_VALUE_23 VARCHAR(500),
    CORRELATION_VALUE_24 VARCHAR(500),
    CORRELATION_VALUE_25 VARCHAR(500),
    TRANSFILE            VARCHAR(200),
    STATUS_COMMENTS      VARCHAR(500),
    IS_ENCRYPTED         VARCHAR(1),
    CORRELATION_VALUE_26 VARCHAR(255),
    CORRELATION_VALUE_27 VARCHAR(255),
    CORRELATION_VALUE_28 VARCHAR(255),
    CORRELATION_VALUE_29 VARCHAR(255),
    CORRELATION_VALUE_30 VARCHAR(255),
    CORRELATION_VALUE_31 VARCHAR(255),
    CORRELATION_VALUE_32 VARCHAR(255),
    CORRELATION_VALUE_33 VARCHAR(255),
    CORRELATION_VALUE_34 VARCHAR(255),
    CORRELATION_VALUE_35 VARCHAR(255),
    CORRELATION_VALUE_36 VARCHAR(255),
    CORRELATION_VALUE_37 VARCHAR(255),
    CORRELATION_VALUE_38 VARCHAR(255),
    CORRELATION_VALUE_39 VARCHAR(255),
    CORRELATION_VALUE_40 VARCHAR(255),
    CORRELATION_VALUE_41 VARCHAR(255),
    CORRELATION_VALUE_42 VARCHAR(255),
    CORRELATION_VALUE_43 VARCHAR(255),
    CORRELATION_VALUE_44 VARCHAR(255),
    CORRELATION_VALUE_45 VARCHAR(255),
    CORRELATION_VALUE_46 VARCHAR(255),
    CORRELATION_VALUE_47 VARCHAR(255),
    CORRELATION_VALUE_48 VARCHAR(255),
    CORRELATION_VALUE_49 VARCHAR(255),
    CORRELATION_VALUE_50 VARCHAR(255),
    ISA_CTL              VARCHAR(15),
    GS_CTL               VARCHAR(15),
    ST_CTL               VARCHAR(15),
    FA_REQ               VARCHAR(1),
    ...
    SRC_CHAR_CNT         VARCHAR(200),
    TP_ISA_ID            VARCHAR(200),
    MY_ISA_ID            VARCHAR(200),
