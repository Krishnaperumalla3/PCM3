...
-------------------------------------------------------------
--   ORACLE DDL STATEMENT FOR 	PETPE_PROCESS_API, 
...
(
    ...
    PROFILE_ID      VARCHAR2(555) NOT NULL ENABLE,
...
(
    PK_ID       VARCHAR2(30) NOT NULL ENABLE,
    PROCESS_REF VARCHAR2(30) NOT NULL ENABLE,
    METHOD_NAME VARCHAR2(15) NOT NULL ENABLE,
    FILTER      VARCHAR2(100),
